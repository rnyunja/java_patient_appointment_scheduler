...
import com.patients.pkg.LoginController;
...
//@Cucumber.Options(format={"SimpleHtmlReport:report/smokeTest.html"},tags={"@smokeTest",”@WhenLogingAsAClientTest”})

public class WhenLogingAsAClientTest extends Mockito{
	...
	/**
	 * Test method for {@link com.patients.pkg.test.LoginController#LoginController()}.
	...
	/**
	 * Test method for {@link com.patients.pkg.test.LoginController#doGet(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}.
...
//        stringWriter.flush(); // it may not have been flushed yet...
	 ...
	 * Test method for {@link com.patients.pkg.test.LoginController#doPost(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}.
	 * 
